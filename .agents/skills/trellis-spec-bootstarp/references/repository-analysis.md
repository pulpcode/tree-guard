...
| Runtime layers | Which code is deterministic core, CLI/application boundary, Provider, contract, test-only, or tooling? |
...
get_file_structure({repo_name: "package-name", file_path: "src/treeguard/diff.py"})
