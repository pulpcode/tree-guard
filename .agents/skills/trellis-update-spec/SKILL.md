...
```
.trellis/spec/
├── backend/           # TreeGuard Python core and CLI standards
...
## Relationship to Other Trellis Entry Points
...
- `trellis-finish-work` skill - Reminds Codex to check if specs need updates
