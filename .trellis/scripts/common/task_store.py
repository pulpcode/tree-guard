...
_SUBAGENT_CONFIG_DIRS: tuple[str, ...] = (
    ".claude",
    ".cursor",
    # TreeGuard uses Codex inline mode and deliberately does not consume JSONL
    # context paths. Keep `.codex` out of this list so task creation does not
    # seed or request implement/check manifests for the supported host.
    ".kiro",
    ".gemini",
    ".opencode",
    ".qoder",
...
def cmd_create(args: argparse.Namespace) -> int:
    ...
    # TreeGuard's supported Codex inline mode is intentionally excluded.
